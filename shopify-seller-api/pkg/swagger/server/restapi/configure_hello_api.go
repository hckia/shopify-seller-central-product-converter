...
func configureAPI(api *operations.HelloAPIAPI) http.Handler {
	...
	if api.GetProductMakeHandler == nil {
		api.GetProductMakeHandler = operations.GetProductMakeHandlerFunc(func(params operations.GetProductMakeParams) middleware.Responder {
			return middleware.NotImplemented("operation operations.GetProductMake has not yet been implemented")
		})
	}
	if api.GetSwatchMakeHandler == nil {
		api.GetSwatchMakeHandler = operations.GetSwatchMakeHandlerFunc(func(params operations.GetSwatchMakeParams) middleware.Responder {
			return middleware.NotImplemented("operation operations.GetSwatchMake has not yet been implemented")
		})
	}
