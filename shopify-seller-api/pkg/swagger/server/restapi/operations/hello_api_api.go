...
func NewHelloAPIAPI(spec *loads.Document) *HelloAPIAPI {
	return &HelloAPIAPI{
		...
		GetProductMakeHandler: GetProductMakeHandlerFunc(func(params GetProductMakeParams) middleware.Responder {
			return middleware.NotImplemented("operation GetProductMake has not yet been implemented")
		}),
		GetSwatchMakeHandler: GetSwatchMakeHandlerFunc(func(params GetSwatchMakeParams) middleware.Responder {
			return middleware.NotImplemented("operation GetSwatchMake has not yet been implemented")
		}),
...
type HelloAPIAPI struct {
	...
	// GetProductMakeHandler sets the operation handler for the get product make operation
	GetProductMakeHandler GetProductMakeHandler
	// GetSwatchMakeHandler sets the operation handler for the get swatch make operation
	GetSwatchMakeHandler GetSwatchMakeHandler
...
func (o *HelloAPIAPI) Validate() error {
	...
	if o.GetProductMakeHandler == nil {
		unregistered = append(unregistered, "GetProductMakeHandler")
	}
	if o.GetSwatchMakeHandler == nil {
		unregistered = append(unregistered, "GetSwatchMakeHandler")
	}
...
func (o *HelloAPIAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/product/{make}"] = NewGetProductMake(o.context, o.GetProductMakeHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/swatch/{make}"] = NewGetSwatchMake(o.context, o.GetSwatchMakeHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
